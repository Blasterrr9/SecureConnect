    ...
    private val callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        override fun onVerificationFailed(e: FirebaseException) {
            if (e is FirebaseAuthInvalidCredentialsException) {
                Toast.makeText(this@AdminActivity, "Solicitud inválida.", Toast.LENGTH_SHORT).show()
            } else if (e is FirebaseTooManyRequestsException) {
                Toast.makeText(this@AdminActivity, "Se excedió el límite de solicitudes.", Toast.LENGTH_SHORT).show()
            } else {
                Toast.makeText(this@AdminActivity, "Error de verificación: ${e.message}", Toast.LENGTH_SHORT).show()
            }
        }
